...
final class FilesystemTest extends TestCase
{
    ...
    {
        $this->root = sys_get_temp_dir() . '/publish-fs-test-' . bin2hex(random_bytes(6));
        mkdir($this->root, 0o755, true);

        $this->logFile = sys_get_temp_dir() . '/publish-fs-log-' . bin2hex(random_bytes(6)) . '.log';
    ...
    private function onAnotherMount(): string
    {
        ...
        $this->otherMount = '/dev/shm/publish-fs-test-' . bin2hex(random_bytes(6));
