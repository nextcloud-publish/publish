 ...
 * `build_results` transport in its own messenger.yaml. Consumed here by
 * App\Message\BuildSucceededHandler.
 *
 * HAND-SYNCED with ssg-worker's App\Message\BuildSucceeded: same FQCN, same
