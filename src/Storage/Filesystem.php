...
/**
 * The handful of filesystem primitives the promoter needs, each failing with
 * the operating system's own reason rather than a generic message.
 *
 ...
 * "rename failed" otherwise, and the result worker retries for two minutes
 * before parking a message that says nothing useful. Mirrors the idiom in
 * ssg-worker's App\Job\Helper.
 */
