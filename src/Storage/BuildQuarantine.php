...
final class BuildQuarantine
{
    ...
    public function quarantine(string $staticSiteId, string $buildId): bool
    {
        try {
            ...
            // things ssg-worker fails a build FOR, so it arrives here routinely.
            // There is no directory to move (JobWorkspace threw before creating
            // one) and the ids cannot be used to build a path safely.
